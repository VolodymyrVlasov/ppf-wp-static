    ...
    <ul id="shipping_method" class="woocommerce-shipping-methods col gap width_100">
        ...
        <li class="checkout_input_radio_wrapper">
            <div class="checkout_input_radio">
                <input type="radio" name="shipping_method[0]" data-index="0" id="shipping_method_0_local_pickup1"
                    value="local_pickup:2" class="shipping_method">
                ...
                <div class="checkout_np_shipping_types">
                    <li class="checkout_input_checkbox">
                        <input type="radio" name="shipping_method[0]" data-index="0"
                            id="shipping_method_0_nova_poshta_shipping_method" value="nova_poshta_shipping_method"
                            class="shipping_method" checked>
                        <label for="shipping_method_0_nova_poshta_shipping_method">Відділення</label>
                    </li>
                    <li class="checkout_input_checkbox">
                        <input type="radio" name="shipping_method[0]" data-index="0"
                            id="shipping_method_0_nova_poshta_shipping_method_poshtomat"
                            value="nova_poshta_shipping_method_poshtomat" class="shipping_method">
                        <label for="shipping_method_0_nova_poshta_shipping_method_poshtomat">Поштомат</label>
                    </li>
                    <li class="checkout_input_checkbox">
                        <input type="radio" name="shipping_method[0]" data-index="0"
                            id="shipping_method_0_npttn_address_shipping_method" value="npttn_address_shipping_method"
