...
<div class="row small_gap">
	...
	?>
	<div class="custom_number_wrapper">
		<button type="button" id="amount-minus" class="custom_number_btn minus" onclick="this.nextElementSibling.stepDown()"
			aria-label="зменшити кількість на 1"></button>
		<input type="<?php echo esc_attr($type); ?>" <?php echo $readonly ? 'readonly="readonly"' : ''; ?>
			id="<?php echo esc_attr($input_id); ?>" class="custom_input_input__number"
		...
		<button type="button" id="amount-plus" class="custom_number_btn plus" onclick="this.previousElementSibling.stepUp()"
			aria-label="збільшити кількість на 1"></button>
	</div>
	<?php
	/**
