                                                    ...
                                                    <li class="checkout_input_radio_wrapper">
                                                        ...
                                                        <div class="checkout_input_radio_legend" id="shipping_method_0_nova_poshta_shipping_method_legend">
                                                            ...
                                                            <div class="col small_gap width_100 margin-top">
                                                                <p class="width_100 form-row" id="billing_nova_poshta_region_field" data-priority="120">
                                                                ...
                                                                <!-- Місто -->
                                                                <p class="width_100 form-row" id="billing_nova_poshta_city_field" data-priority="122" class="flex_1">
                                                                ...
                                                                <!-- Відділення / Поштомат -->
                                                                <p class="width_100 form-row validate-required" id="billing_nova_poshta_warehouse_field" data-priority="124" class="flex_1">
