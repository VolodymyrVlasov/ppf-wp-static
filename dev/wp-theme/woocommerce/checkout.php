                                        ...
                                        <div class="col gap width_100">
                                            ...
                                            <div class="row big_gap width_100">
                                                <div class="checkout_input_text" id="billing_first_name_field" data-priority="10">
                                                    ...
                                                    <input type="text" name="billing_first_name" id="billing_first_name" value="" autocomplete="given-name" required="true" placeholder="Тарас">
                                                </div>


                                                <div class="checkout_input_text" id="billing_last_name_field" data-priority="20">
                                                    <label for="billing_last_name">Прізвище</label>
                                                    <input type="text" name="billing_last_name" id="billing_last_name" value="" autocomplete="family-name" required="true" placeholder="Шевченко">
                                                </div>
                                                ...
                                                <div class="checkout_input_text form-row my-custom-class" id="billing_mrkvnp_patronymics_field" data-priority="136" style="display: none;">
                                                    <label for="billing_mrkvnp_patronymics" class="">По батькові</label>
                                            ...
                                            <div class="row big_gap width_100">
                                                ...
                                                <div class="checkout_input_text" id="billing_email_field" data-priority="110">
                                                    ...
                                                    <input type="email" name="billing_email" id="billing_email" autocomplete="email" required="true" placeholder="superman@shevchenko.ua">
                                                </div>
                                            </div>
                                                ...
                                                <ul id="shipping_method" class="woocommerce-shipping-methods col gap width_100">
                                                    ...
                                                    <li class="checkout_input_radio_wrapper">
                                                        ...
                                                        <div class="checkout_input_radio_legend" id="shipping_method_0_nova_poshta_shipping_method_legend">
                                                            ...
                                                            <div class="shipping_address margin-top-small" style="display: none;">
                                                                <div class="woocommerce-shipping-fields__field-wrapper col small_gap width_100">
                                                                    <div class="row gap width_100">
                                                                        <div class="checkout_input_text form-row" id="shipping_first_name_field" data-priority="10">
                                                                            <label for="shipping_first_name">* Імʼя</label>
                                                                            <input type="text" name="shipping_first_name" id="shipping_first_name" value="" autocomplete="given-name" required="true" placeholder="Тарас">
                                                                        </div>
                                                                        <div class="checkout_input_text form-row" id="shipping_last_name_field" data-priority="20">
                                                                            <label for="shipping_last_name">Прізвище</label>
                                                                            <input type="text" name="shipping_last_name" id="shipping_last_name" value="" autocomplete="family-name" required="true" placeholder="Шевченко">
                                                                        </div>
                                                                        <div class="checkout_input_text form-row my-custom-class" id="shipping_mrkvnp_patronymics_field" data-priority="20" style="display: none;s">
                                                                            <label for="shipping_last_name">По батькові</label>
                                                                            <input type="text" name="shipping_mrkvnp_patronymics" id="shipping_mrkvnp_patronymics" value="" autocomplete="family-name" required="true" placeholder="Григорович">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row gap width_100">
                                                                        <div class="checkout_input_text form-row" id="shipping_phone_field" data-priority="100">
                                                                            <label for="shipping_phone">Мобільний телефон</label>
                                                                            <input type="tel" id="shipping_phone" required="true" placeholder=" +38 077 777 7777" name="shipping_phone" autocomplete="tel">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>

                                                            <ul class="checkout_np_shipping_types">
                                                            ...
                                                            <div class="woocommerce-billing-fields">
                                                                ...
                                                                <div class="col small_gap width_100 margin-top">
                                                                    <p class="width_100 form-row checkout_input_text" id="billing_nova_poshta_region_field" data-priority="120">
                                                                        <label for="billing_nova_poshta_region" class="flex_1">Область</label>
                                                                        <span class="woocommerce-input-wrapper">
                                                                            <select name="billing_nova_poshta_region" id="billing_nova_poshta_region" class="select2-hidden-accessible" data-allow_clear="true" data-placeholder="Оберіть область" tabindex="-1" aria-hidden="true">
                                                                    ...
                                                                    <!-- Місто -->
                                                                    <p class="width_100 form-row checkout_input_text" id="billing_nova_poshta_city_field" data-priority="122" class="flex_1">
                                                                        <label for="billing_nova_poshta_city" class="">Місто&nbsp;<abbr class="" title="обов&#39;язкове">*</abbr></label>
                                                                        <span class="woocommerce-input-wrapper">
                                                                            <select name="billing_nova_poshta_city" id="billing_nova_poshta_city" class="select2-hidden-accessible" data-allow_clear="true" data-placeholder="Оберіть місто" tabindex="-1" aria-hidden="true">
                                                                                <option value="" selected="selected">Оберіть область</option>
                                                                            </select>
                                                                        </span>
                                                                    </p>
                                                                    ...
                                                                    <!-- Відділення / Поштомат -->
                                                                    <p class="width_100 form-row validate-required checkout_input_text" id="billing_nova_poshta_warehouse_field" data-priority="124" class="flex_1">
                                                                        <label for="billing_nova_poshta_warehouse" class="">Поштомат<span>&nbsp;*</span></label>
                                                                        <span class="woocommerce-input-wrapper">
                                                                            <select name="billing_nova_poshta_warehouse" id="billing_nova_poshta_warehouse" class="select2-hidden-accessible" data-allow_clear="true" data-placeholder="Нічого не вибрано" tabindex="-1" aria-hidden="true">
                                                                                <option value="" selected="selected">Оберіть область</option>
                                                                            </select>
                                                                        </span>
                                                                    </p>
                                                                    ...
                                                                    <!-- Адресна доставка -->
                                                                    <div class="row gap width_100">
                                                                        <div class="checkout_input_text form-row my-custom-class flex_3" id="billing_mrkvnp_street_field" data-priority="130" style="display: none;">
                                                                            <label for="billing_mrkvnp_street" class="">Вулиця</label>
                                                                            <input type="text" class="input-text " name="billing_mrkvnp_street" id="billing_mrkvnp_street" placeholder="Введіть перші три літери.." disabled="disabled">
                                                                        </div>
                                                                        <div class="checkout_input_text form-row flex_1" id="billing_mrkvnp_house_field" data-priority="132" style="display: none;">
                                                                            <label for="billing_mrkvnp_house" class="">Номер будинку</label>
                                                                            <input type="text" class="input-text " name="billing_mrkvnp_house" id="billing_mrkvnp_house"
                                                                                disabled="disabled">
                                                                        </div>
                                                                        <div class="checkout_input_text form-row flex_1" id="billing_mrkvnp_flat_field" data-priority="134" style="display: none;">
                                                                            <label for="billing_mrkvnp_flat" class="">Квартира / офіс</label>
                                                                ...
                                                                <div class="woocommerce-shipping-fields">
                                                                    <div class="shipping_address" style="display: none;">
                                                                        ...
                                                                        <p class="form-row address-field validate-required form-row-wide" id="shipping_address_1_field" data-priority="50"><label for="shipping_address_1" class="">Назва вулиці&nbsp;<abbr class="required"
                                                                                    title="обов&#39;язкове">*</abbr></label><span class="woocommerce-input-wrapper"><input type="text" class="input-text " name="shipping_address_1" id="shipping_address_1" placeholder="Номер будинку та назва вулиці"
                                                                                    value=""
                                                                        ...
                                                                        <p class="form-row address-field validate-required form-row-wide" id="shipping_city_field" data-priority="70" data-o_class="form-row form-row-wide address-field validate-required"><label for="shipping_city" class="">Місто /
                                                                                Село&nbsp;<abbr
                                                                        ...
                                                                        <p class="form-row address-field validate-required validate-state form-row-wide" id="shipping_state_field" data-priority="80" data-o_class="form-row form-row-wide address-field validate-required validate-state"><label
                                                                                for="shipping_state"
                                                                                class="">Область / Округ&nbsp;<abbr class="required" title="обов&#39;язкове">*</abbr></label><span class="woocommerce-input-wrapper"><select name="shipping_state" id="shipping_state"
                                                                                ...
                                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" aria-haspopup="true"
                                                                                            aria-expanded="false"
                                                                                            tabindex="0" aria-label="Область / Округ" role="combobox"><span class="select2-selection__rendered" id="select2-shipping_state-container" role="textbox" aria-readonly="true" title="місто Київ">місто
                                                                                                Київ</span><span
                                                                        ...
                                                                        <p class="form-row validate-required" id="shipping_nova_poshta_warehouse_field" data-priority="124"><label for="shipping_nova_poshta_warehouse" class="">Відділення&nbsp;<abbr class="required"
                                                                        ...
                                                                        <p class="form-row form-row-last" id="shipping_mrkvnp_flat_field" data-priority="134"><label for="shipping_mrkvnp_flat" class="">Кв.&nbsp;<span class="optional">(необов'язково)</span></label><span
